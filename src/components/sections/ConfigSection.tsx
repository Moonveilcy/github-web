...
export const ConfigSection = ({ token, setToken, storeToken, setStoreToken, repo, setRepo, branch, setBranch }: ConfigSectionProps) => {
    ...
    // Fungsi untuk mengekstrak 'owner/repo' dari URL atau teks biasa
    const handleRepoChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            if (value.startsWith('http')) {
                ...
                // Ambil pathnamenya (cth: /owner/repo) dan hapus slash di awal
            ...
            // Biarkan saja jika bukan URL valid, user mungkin sedang mengetik
        }
        setRepo(value);
    };
    ...
    return (
        <section className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-8">
            ...
            <input
                ...
                value={repo}
                // Gunakan fungsi handler yang baru
